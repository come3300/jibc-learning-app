            ...
            <h1 className="text-3xl font-bold text-gray-900 title-font mb-2">インターネット入門</h1>
              ...
              <div className="py-8 flex flex-wrap md:flex-nowrap">
                ...
                <div className="md:flex-grow">
                  <h2 className="text-2xl font-bold text-gray-900 title-font mb-2">インターネットの仕組み</h2>
              ...
              <div className="py-8 flex flex-wrap md:flex-nowrap">
                ...
                <div className="md:flex-grow">
                  <h2 className="text-2xl font-bold text-gray-900 title-font mb-2">サーバーの仕組み</h2>
              ...
              <div className="py-8 flex flex-wrap md:flex-nowrap">
                <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                  <span className="font-semibold title-font text-gray-700">Section3</span>
