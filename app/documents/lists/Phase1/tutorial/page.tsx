    ...
    <main>
        <section className="default-inch text-gray-600 body-font overflow-hidden">
          <div className="container px-5 py-24 mx-auto">
            ...
            <h1 className="text-3xl font-bold text-gray-900 title-font mb-2">まずはじめに</h1>

              <div className="py-8 flex flex-wrap md:flex-nowrap">
                <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                  <span className="font-semibold title-font text-gray-700">Part1</span>
                  <span className="mt-1 text-gray-500 text-sm">目安:1時間</span>
                </div>
                <div className="md:flex-grow">
                  <h2 className="text-2xl font-bold text-gray-900 title-font mb-2">この講座について</h2>
              ...
              <div className="py-8 flex flex-wrap md:flex-nowrap">
                <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                  <span className="font-semibold title-font text-gray-700">PART2</span>
                  <span className="mt-1 text-gray-500 text-sm">目安:1時間</span>
                </div>
                <div className="md:flex-grow">
                  <h2 className="text-2xl font-bold text-gray-900 title-font mb-2">エンジニアになるための考え方</h2>
              ...
              <div className="py-8 flex flex-wrap md:flex-nowrap">
                ...
                <div className="md:flex-grow">
                  <h2 className="text-2xl font-bold text-gray-900 title-font mb-2">セットアップしてみよう！</h2>
