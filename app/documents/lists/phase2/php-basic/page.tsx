      ...
      <section className="default-inch text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="-my-8 divide-y-2 divide-gray-100">
            <h1 className="text-3xl font-bold text-gray-900 title-font mb-2">php基礎</h1>

            <ArticleCard
              section="Part1"
              title="phpとは"
              description="phpって何ができて、どんな特徴がなるのかを解説していきます"
              duration="40m"
            ...
            <ArticleCard
              section="Part2"
              title="phpの仕組み"
              description="phpがどのように動いているのか、仕組みについて理解していきましょう!"
            ...
            <ArticleCard
              section="Part3"
              title="変数とは"
              description="プログラミング言語を学ぶ上でとても大切な「変数」という概念についてphpを用いて理解していきます"
              duration="48:32 minutes"
              featuring={["Barry", "Sandra", "August"]}
              link="#"
            />
