...
## Phase1  インターネットの仕組み
<img src="/phase1/internet/network.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
<img src="/phase1/internet/リクエストレスポンス.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
<img src="/phase1/internet/httpについて.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
このレスはレスポンスのことで同様に連絡したことに対して
連絡を返してくれますよね？このことと同じです。
...
<img src="/phase1/internet/http.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
<img src="/phase1/internet/CRUD.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
※エンジニアとして実務をこなしていくとちょいちょい目にする機会があるかもしれません
...
<img src="/phase1/internet/CRUD-GET.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
押したとします。するとその送信した情報をサーバーに送ってくれます。
 ...
 <img src="/phase1/internet/CRUD-POST.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
<img src="/phase1/internet/CRUD-PUT.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
<img src="/phase1/internet/CRUD-DELETE.png" loading="lazy" alt="Photo by Minh Pham" class="" />
...
インターネット→世界中のコンピューターをつなぎ合わせる巨大なネットワーク
Web→HTTPという仕組みを利用しホームページやブログを閲覧すること
